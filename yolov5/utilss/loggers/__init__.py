...
from yolov5.utilss.general import LOGGER, colorstr, cv2
from yolov5.utilss.loggers.clearml.clearml_utils import ClearmlLogger
from yolov5.utilss.loggers.wandb.wandb_utils import WandbLogger
from yolov5.utilss.plots import plot_images, plot_labels, plot_results
from yolov5.utilss.torch_utils import de_parallel
...
try:
    if RANK in {0, -1}:
        ...
        from yolov5.utilss.loggers.comet import CometLogger
...
class GenericLogger:
    ...
    Usage: from yolov5.utilss.loggers import GenericLogger; logger = GenericLogger(...)
    Arguments
        opt:             Run arguments
