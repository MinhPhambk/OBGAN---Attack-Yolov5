...
def _create(name, pretrained=True, channels=3, classes=80, autoshape=True, verbose=True, device=None):
    ...
    from yolov5.utilss.downloads import attempt_download
    from yolov5.utilss.general import LOGGER, ROOT, check_requirements, intersect_dicts, logging
    from yolov5.utilss.torch_utils import select_device
...
if __name__ == "__main__":
    ...
    from yolov5.utilss.general import cv2, print_args
