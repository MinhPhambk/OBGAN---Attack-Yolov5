...
from yolov5.utilss.general import LOGGER, TQDM_BAR_FORMAT, colorstr
...
def kmean_anchors(dataset="./data/coco128.yaml", n=9, img_size=640, thr=4.0, gen=1000, verbose=True):
    ...
    Usage:
        from yolov5.utilss.autoanchor import *; _ = kmean_anchors()
    """
    ...
    if isinstance(dataset, str):  # *.yaml file
        ...
        from yolov5.utilss.dataloaders import LoadImagesAndLabels
