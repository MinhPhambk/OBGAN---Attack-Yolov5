...
from yolov5.utilss import TryExcept
from yolov5.utilss.dataloaders import exif_transpose, letterbox
...
from yolov5.utilss.torch_utils import copy_attr, smart_inference_mode
...
class DetectMultiBackend(nn.Module):
    ...
    def __init__(self, weights="yolov5s.pt", device=torch.device("cpu"), dnn=False, data=None, fp16=False, fuse=True):
        ...
        if pt:  # PyTorch
            ...
            from yolov5.utilss.triton import TritonRemoteModel
    ...
    def _model_type(p="path/to/model.pt"):
        ...
        from yolov5.utilss.downloads import is_url
